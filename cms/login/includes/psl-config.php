...
define("USER", "kayrosst_consolidacion"); 			// The database username. 
define("PASSWORD", "C0nsolidac1on!"); 	// The database password. 
define("DATABASE", "kayrosst_consolidacion");             // The database name.
